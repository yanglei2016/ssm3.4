package com.yang.http.common.util;
...
import com.yang.http.HttpClientUtil;
...
public class OldOCR {
	...
	private static final Header[] headers = HttpHeader.getInstance()
	...
	public static String ocrCode(String imgFilePath, int limitCodeLen){
        ...
        Map<String , Object> m = new HashMap<String, Object>();
  		...
  		String html;
		try {
			html = HttpClientUtil.post(HttpConfig.getInstance().client(client).url(apiUrl).headers(headers).map(m));
